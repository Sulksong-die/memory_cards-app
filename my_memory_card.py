...
questions_list = []  
questions_list.append(Question('Скоро рассвет, выхода нет, ключ поверни и ...?', 'Полетели!', 'Отпусти!', 'Полетел!', 'Постой!')) 
questions_list.append(Question('Самая знаменитая группа в 80-х?', 'Кино', 'Сплин', 'Киш', 'Ленинград')) 
questions_list.append(Question('Сколько частей в Гарри Поттере', '8', '7', '9', '10')) 
questions_list.append(Question('РДТЧПШС..?', 'В', 'Д', 'О', 'Ч'))
